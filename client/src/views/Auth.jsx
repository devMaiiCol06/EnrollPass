                        ...
                        {authView === "login" ? (
                            ...
                            <div className={styles.importantMsgContainer}>
                                <h3 className={styles.importantMsgTitle}>
                                    <Icon icon="gravity-ui:exclamation-shape" />
                                    A tener en cuenta:
                                </h3>
                                <p className={styles.importantMsgText}>
                                    La plataforma permite un registro inicial
                                    con información básica. Sin embargo, para
                                    habilitar el proceso de inscripción de
                                    matrículas, es obligatorio completar los
